...
TRANSLATIONS = {
    'es': {
        ...
        'label_clear_cache': 'Eliminar imágenes en caché y datos temporales',
        'confirm_clear_cache': '¿Estás seguro de que deseas eliminar toda la caché? Esto borrará todas las imágenes descargadas y datos temporales.',
        'cache_cleared_title': 'Caché Eliminada',
        'cache_cleared_message': 'La caché se ha eliminado exitosamente. Se liberaron {size} MB.',
        'cache_clear_error': 'Error al eliminar la caché: {error}',
        
        # Auto-Update System
        'btn_check_updates': 'Buscar Actualizaciones',
        'label_current_version': 'Versión actual: {version}',
        'label_checking_updates': 'Buscando actualizaciones...',
        'update_available_title': 'Actualización Disponible',
        'update_available_message': 'Una nueva versión está disponible: v{version}\n\nPublicada: {date}\nTamaño: {size} MB\n\n¿Deseas descargar e instalar ahora?',
        'no_update_title': 'Sin Actualizaciones',
        'no_update_message': 'Ya tienes la última versión instalada.',
        'downloading_update': 'Descargando actualización...',
        'download_progress': 'Descargando: {percent}% ({downloaded} MB / {total} MB)',
        'installing_update': 'Instalando actualización...',
        'update_success_title': 'Actualización Descargada',
        'update_success_message': 'La actualización se descargó exitosamente.\n\nLa aplicación se reiniciará para completar la instalación.',
        'update_error_title': 'Error de Actualización',
        'update_error_message': 'No se pudo descargar o instalar la actualización:\n{error}',
        'update_check_error': 'Error al buscar actualizaciones: {error}',
        'changelog_title': 'Novedades en v{version}',
        'no_changelog': 'No hay changelog disponible.',
        'label_auto_update': 'Buscar actualizaciones automáticamente',
        'hint_auto_update': 'Verifica actualizaciones al iniciar la aplicación',
        'changelog_dialog_title': 'Novedades',
        'btn_close': 'Cerrar',
        ...
        'btn_apply': 'Aplicar',
        'btn_overwrite_theme': 'Sobrescribir',
    ...
    'en': {
        ...
        'label_clear_cache': 'Delete cached images and temporary data',
        'confirm_clear_cache': 'Are you sure you want to clear all cache? This will delete all downloaded images and temporary data.',
        'cache_cleared_title': 'Cache Cleared',
        'cache_cleared_message': 'Cache has been successfully cleared. Freed {size} MB.',
        'cache_clear_error': 'Error clearing cache: {error}',
        
        # Auto-Update System
        'btn_check_updates': 'Check for Updates',
        'label_current_version': 'Current version: {version}',
        'label_checking_updates': 'Checking for updates...',
        'update_available_title': 'Update Available',
        'update_available_message': 'A new version is available: v{version}\n\nPublished: {date}\nSize: {size} MB\n\nDo you want to download and install it now?',
        'no_update_title': 'No Updates',
        'no_update_message': 'You already have the latest version installed.',
        'downloading_update': 'Downloading update...',
        'download_progress': 'Downloading: {percent}% ({downloaded} MB / {total} MB)',
        'installing_update': 'Installing update...',
        'update_success_title': 'Update Downloaded',
        'update_success_message': 'The update was downloaded successfully.\n\nThe application will restart to complete the installation.',
        'update_error_title': 'Update Error',
        'update_error_message': 'Failed to download or install the update:\n{error}',
        ...
        'hint_auto_update': 'Check for updates when starting the application',
        'changelog_dialog_title': 'What\'s New',
        'btn_close': 'Close',
